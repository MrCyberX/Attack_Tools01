...
echo""
echo $ku"★▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬●★"
echo $pr" Author   ~~> KAPTEN"
echo $me" YouTube  ~~> Hacker Boss"
echo $pu" Github   ~~> https://github.com/Mr-CYBER"
echo $cy" my_Group ~~> ACEH_CYBER_AMRY"
echo $bi"★▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬●★"
echo""
echo $hi"       █████████
      $pu █▄█████▄█        $me ●▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬●
       █ ▼▼▼▼▼  - _ --_--$hi ╔╦╗┌─┐┬─┐┬┌─
       █    _-_-- -_ --__ $cy ║║├─┤├┬┘├┴┐─── $hi TOOLS
       █ ▲▲▲▲▲ --  - _ -- ═╩╝┴ ┴┴└─┴ ┴   ╚ $me HackeMr-CYBER
       █████████        $ku «==========✧==========»
       ██ "
echo "★▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬●★"
echo "[¤Φ¤] No system is safe to hack" $me By•• Mr•CYBER
echo "«==============®©===============»" | lolcat 
date
echo $bi" [1]•Evil-create-framework"
echo $hi" [2]•Darknetv1"
echo $cy" [3]•weeman"
echo $pr" [4]•style"
echo $me" [5]•RED_HAWK"
echo $pu" [6]•hammer"
echo $ku" [7]•lucita_ddos"
echo $me" [8]•MrDdos"
echo $pu" [9]•ddosWD"
echo $ku" [10]•VA-DDOS"
echo $cy" [11]•B-ATTACKING"
echo $bi" [12]•xerxes"
echo $hi" [13]•torshammer"
echo $pu" [14]•LITEDDOS"
echo $cy" [15]•Tool-X"
echo $hi" [16]•terkey"
echo $cy" [17]•Spam_wa"
echo $ku" [18]•6VIRUS"
echo $me" [19]•terkey"
echo $cy" [00]•install bahan dulu ya bossqu"
echo $cy"★▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬●★"

echo "••> PLEASE CHOOSE THE NUMBER THAT YOU INSTALL <••" | lolcat -a -d 100
echo "=================================================" | lolcat -a -d 50
echo "••> USE THIS TOOL WELL <••" | lolcat -a -d 100
echo $pu"★▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬●★"
read -p " [DDOSTools] ••> " pil :
  if [ $bro = 00 ] |
then
clear
...
if [ $pil = 17 ]
then
git clone https://github.com/RuangCoder/spam_wa
cd spam_wa
pyrhon2 wa.py
fi
#batas gen
